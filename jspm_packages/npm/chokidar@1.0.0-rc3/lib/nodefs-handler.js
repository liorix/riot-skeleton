...
(function(process) {
  ...
  function setFsWatchListener(path, fullPath, options, handlers) {
    ...
    if (!options.persistent) {
      return createFsWatchInstance(path, options, listener, errHandler, rawEmitter);
    } else if (!container) {
  ...
  NodeFsHandler.prototype._addToNodeFs = function(path, initialAdd, priorWh, depth, target, callback) {
    ...
    fs[wh.statMethod](wh.watchPath, function(error, stats) {
      ...
      var permError = this.options.ignorePermissionErrors && !this._hasReadPermissions(stats);
