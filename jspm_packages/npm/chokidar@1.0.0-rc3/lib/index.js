...
(function(process) {
  ...
  FSWatcher.prototype._handleError = function(error) {
    ...
    if (error && code !== 'ENOENT' && code !== 'ENOTDIR' && !(code === 'EPERM' && !this.options.ignorePermissionErrors))
  ...
  FSWatcher.prototype._getWatchHelpers = function(path) {
    ...
    var filterPath = function(entry) {
      return (!hasGlob || globFilter(entryPath(entry))) && this._isntIgnored(entryPath(entry), entry.stat);
    }.bind(this);
