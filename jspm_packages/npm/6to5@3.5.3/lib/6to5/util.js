...
(function(Buffer) {
  ...
  var templateVisitor = {enter: function(node, parent, scope, nodes) {
  ...
  var loadTemplates = function() {
    ...
    if (!fs.existsSync(templatesLoc)) {
      throw new Error("no templates directory - this is most likely the " + "result of a broken `npm publish`. Please report to " + "https://github.com/6to5/6to5/issues");
    }
