...
var runnerSettersVisitor = {enter: function(node, parent, scope, state) {
...
var hoistVariablesVisitor = {enter: function(node, parent, scope, hoistDeclarators) {
...
var hoistFunctionsVisitor = {enter: function(node, parent, scope, handlerBody) {
    if (t.isFunction(node))
      this.skip();
