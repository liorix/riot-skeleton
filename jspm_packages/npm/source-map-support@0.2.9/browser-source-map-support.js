...
(function(Buffer, process) {
  (this.define || function(J, N) {
    this.sourceMapSupport = N();
  })("browser-source-map-support", function(J) {
    (function h(r, m, e) {
      function p(g, d) {
        if (!m[g]) {
          if (!r[g]) {
      ...
      3: [function(h, r, m) {
        function e(f, n, w) {
          ...
          if (e._useTypedArrays && "number" === typeof f.byteLength)
            ...
            var d = f;
            if (x(d) || e.isBuffer(d) || d && "object" === typeof d && "number" === typeof d.length)
              for (n = 0; n < b; n++)
                e.isBuffer(f) ? c[n] = f.readUInt8(n) : c[n] = f[n];
            else if ("string" === a)
              c.write(f, 0, n);
            else if ("number" === a && !e._useTypedArrays && !w)
              for (n = 0; n < b; n++)
                c[n] = 0;
          }
          return c;
        ...
        function p(f, n, w) {
          var a = "";
          for (w = Math.min(f.length, w); n < w; n++)
            a += String.fromCharCode(f[n]);
          return a;
        }
        function u(f, n, w, a) {
          a || (q("boolean" === typeof w, "missing or invalid endian"), q(void 0 !== n && null !== n, "missing offset"), q(n + 1 < f.length, "Trying to read beyond buffer length"));
          a = f.length;
          if (!(n >= a))
            return w ? (w = f[n], n + 1 < a && (w |= f[n + 1] << 8)) : (w = f[n] << 8, n + 1 < a && (w |= f[n + 1])), w;
        }
        function z(f, n, a, c) {
        ...
        function g(f, n, a, b) {
          ...
          if (!(n >= f.length))
            return f = u(f, n, a, !0), f & 32768 ? -1 * (65535 - f + 1) : f;
        }
        function d(f, n, a, b) {
          ...
          if (!(n >= f.length))
            return f = z(f, n, a, !0), f & 2147483648 ? -1 * (4294967295 - f + 1) : f;
        }
        function k(f, n, a, b) {
        ...
        function c(f, n, a, b, c) {
          c || (q(void 0 !== n && null !== n, "missing value"), q("boolean" === typeof b, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 1 < f.length, "trying to write beyond buffer length"), K(n, 65535));
          var d = f.length;
          if (!(a >= d))
        ...
        function a(f, n, a, b, c) {
          c || (q(void 0 !== n && null !== n, "missing value"), q("boolean" === typeof b, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < f.length, "trying to write beyond buffer length"), K(n, 4294967295));
          var d = f.length;
          if (!(a >= d))
        ...
        function b(f, n, a, b, d) {
          d || (q(void 0 !== n && null !== n, "missing value"), q("boolean" === typeof b, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 1 < f.length, "Trying to write beyond buffer length"), L(n, 32767, -32768));
          a >= f.length || (0 <= n ? c(f, n, a, b, d) : c(f, 65535 + n + 1, a, b, d));
        }
        function y(f, n, b, c, d) {
          d || (q(void 0 !== n && null !== n, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== b && null !== b, "missing offset"), q(b + 3 < f.length, "Trying to write beyond buffer length"), L(n, 2147483647, -2147483648));
          b >= f.length || (0 <= n ? a(f, n, b, c, d) : a(f, 4294967295 + n + 1, b, c, d));
        }
        function B(f, n, a, b, c) {
          c || (q(void 0 !== n && null !== n, "missing value"), q("boolean" === typeof b, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < f.length, "Trying to write beyond buffer length"), M(n, 3.4028234663852886E38, -3.4028234663852886E38));
          a >= f.length || H.write(f, n, a, b, 23, 4);
        }
        function A(f, n, a, b, c) {
          c || (q(void 0 !== n && null !== n, "missing value"), q("boolean" === typeof b, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 7 < f.length, "Trying to write beyond buffer length"), M(n, 1.7976931348623157E308, -1.7976931348623157E308));
        ...
        e.concat = function(f, a) {
          q(x(f), "Usage: Buffer.concat(list, [totalLength])\nlist should be an Array.");
          if (0 === f.length)
            return new e(0);
          if (1 === f.length)
            return f[0];
        ...
        e.prototype.write = function(f, a, b, c) {
          ...
          switch (c) {
            ...
            case "utf8":
            case "utf-8":
              f = e._charsWritten = E(s(f), this, a, b);
              break;
            case "ascii":
              f = e._charsWritten = E(D(f), this, a, b);
              break;
            case "binary":
              f = e._charsWritten = E(D(f), this, a, b);
              break;
            case "base64":
              f = e._charsWritten = E(I.toByteArray(f), this, a, b);
              break;
            case "ucs2":
            case "ucs-2":
            case "utf16le":
            case "utf-16le":
              ...
              f = e._charsWritten = E(d, this, a, b);
              break;
            default:
              throw Error("Unknown encoding");
          }
          ...
          switch (f) {
            ...
            case "utf-8":
              ...
              for (b = Math.min(this.length, b); c < b; c++)
                127 >= this[c] ? (f += F(a) + String.fromCharCode(this[c]), a = "") : a += "%" + this[c].toString(16);
              b = f + F(a);
              break;
            case "ascii":
              b = p(this, a, b);
            ...
            case "base64":
              f = a;
              b = 0 === f && b === this.length ? I.fromByteArray(this) : I.fromByteArray(this.slice(f, b));
              break;
            case "ucs2":
            case "ucs-2":
            case "utf16le":
        ...
        e.prototype.writeUInt8 = function(a, b, c) {
          c || (q(void 0 !== a && null !== a, "missing value"), q(void 0 !== b && null !== b, "missing offset"), q(b < this.length, "trying to write beyond buffer length"), K(a, 255));
        ...
        e.prototype.writeInt8 = function(a, b, c) {
          c || (q(void 0 !== a && null !== a, "missing value"), q(void 0 !== b && null !== b, "missing offset"), q(b < this.length, "Trying to write beyond buffer length"), L(a, 127, -128));
      ...
      5: [function(h, r, m) {
        m.read = function(e, p, u, h, g) {
          ...
          u = b & (1 << -c) - 1;
          b >>= -c;
          for (c += d; 0 < c; u = 256 * u + e[p + g], g += a, c -= 8)
            ;
          d = u & (1 << -c) - 1;
          u >>= -c;
          ...
          return (b ? -1 : 1) * d * Math.pow(2, u - h);
        };
        m.write = function(e, p, u, h, g, d) {
          var k,
              l = 8 * d - g - 1,
              c = (1 << l) - 1,
              a = c >> 1,
          ...
          for (; 8 <= g; e[u + d] = p & 255, d += y, p /= 256, g -= 8)
            ;
          h = h << g | p;
          for (l += g; 0 < l; e[u + d] = h & 255, d += y, h /= 256, l -= 8)
            ;
          e[u + d - y] |= 128 * B;
        };
      }, {}],
      ...
      7: [function(h, r, m) {
        (function(e) {
          ...
          m.join = function() {
            ...
            return m.normalize(u(d, function(d, e) {
              if ("string" !== typeof d)
          ...
          g.prototype._parseMappings = function(a, b) {
            for (var e = 1,
              ...
              if (";" === s.charAt(0))
                ...
                p.generatedLine = e;
                s = c.decode(s);
                p.generatedColumn = g + s.value;
                g = p.generatedColumn;
                s = s.rest;
                if (0 < s.length && !m.test(s.charAt(0))) {
                  s = c.decode(s);
                  p.source = this._sources.at(k + s.value);
                  k += s.value;
                  s = s.rest;
                  if (0 === s.length || m.test(s.charAt(0)))
                    throw Error("Found a source, but no line and column");
                  s = c.decode(s);
                  p.originalLine = l + s.value;
                  l = p.originalLine;
                  p.originalLine += 1;
                  s = s.rest;
                  if (0 === s.length || m.test(s.charAt(0)))
                  ...
                  s = c.decode(s);
                  p.originalColumn = h + s.value;
                  h = p.originalColumn;
                  s = s.rest;
                  0 < s.length && !m.test(s.charAt(0)) && (s = c.decode(s), p.name = this._names.at(x + s.value), x += s.value, s = s.rest);
                }
      ...
      14: [function(h, r, m) {
        ...
        e(function(e, h, m) {
          ...
          g.prototype._serializeMappings = function() {
            ...
            for (var x = 0,
                p = this._mappings.length; x < p; x++) {
              v = this._mappings[x];
              if (v.generatedLine !== a)
                for (c = 0; v.generatedLine !== a; )
                  h += ";", a++;
              else if (0 < x) {
                if (!k.compareByGeneratedPositions(v, this._mappings[x - 1]))
                  continue;
                h += ",";
              }
              h += d.encode(v.generatedColumn - c);
              c = v.generatedColumn;
              v.source && (h += d.encode(this._sources.indexOf(v.source) - l), l = this._sources.indexOf(v.source), h += d.encode(v.originalLine - 1 - e), e = v.originalLine - 1, h += d.encode(v.originalColumn - b), b = v.originalColumn, v.name && (h += d.encode(this._names.indexOf(v.name) - g), g = this._names.indexOf(v.name)));
            }
            return h;
          };
 ...
 while (h < c.generatedLine);
          ...
          g.prototype.toStringWithSourceMap = function(e) {
            ...
            this.walk(function(d, e) {
              c += d;
              null !== e.source && null !== e.line && null !== e.column ? (k === e.source && p === e.line && v === e.column && m === e.name || g.addMapping({
                source: e.source,
                original: {
                  line: e.line,
                  column: e.column
                ...
                name: e.name
              }), k = e.source, p = e.line, v = e.column, m = e.name, h = !0) : h && (g.addMapping({generated: {
                  line: a,
                  column: b
                }}), k = null, h = !1);
        ...
        (function(e, p) {
          r.exports = function(m, r) {
            ...
            A = function(a, b, c, d) {
              ...
              h.toUrl = function(a) {
                return 0 === a.indexOf(".") ? g(a, B.dirname(c.filename)) : a;
              };
              return h;
            };
            r = r || function() {
        ...
        (function(e, p) {
          ...
          function g(a, b) {
            ...
            var c = v.dirname(a),
                d = /^\w+:\/\/[^\/]*/.exec(c),
                d = d ? d[0] : "";
            return d + v.resolve(c.slice(d.length), b);
          }
          function d(a) {
            var b;
            a: {
            ...
            if (!b)
              return null;
            "data:application/json;base64," == b.slice(0, 29).toLowerCase() ? (a = (new p(b.slice(29), "base64")).toString(), b = null) : (b = g(a, b), a = z(b, "utf8"));
            return a ? {
              url: b,
              map: a
            } : null;
          ...
          function k(a) {
            ...
            return b && (c = b.map.originalPositionFor(a), null !== c.source) ? (c.source = g(b.url, c.source), c) : a;
          }
          function l(a) {
          ...
          var C = h("source-map").SourceMapConsumer,
              v = h("path"),
              x = h("fs"),
              G = !1,
              s = !1,
          ...
          m.install = function(a) {
            if (!G) {
              ...
              s = "emptyCacheBetweenOperations" in a ? a.emptyCacheBetweenOperations : !1;
              a.retrieveFile && (z = a.retrieveFile);
